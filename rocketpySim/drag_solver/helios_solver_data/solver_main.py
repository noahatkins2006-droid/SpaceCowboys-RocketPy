...
from drag_solver.solver_functions import rocketSim, f
...
# --- Measured data ---
real_apogee = 1385  # meters


rocketSim(motor_file=motor_file, on_drag=on_drag, off_drag=off_drag, ork_file=ork_file, launch_time="06:00:00", drag_scale=(0.5, 1.5))


# Solve for drag scale
scale_solution = brentq(f, 0.5, 1.5)  # search range for Cd multiplier
